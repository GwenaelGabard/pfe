"""Imposed normal velocity boundary condition for the LPE in cylindrical coordinates"""
import numpy as np


class Velocity:
    r"""Implements the boundary condition for an imposed normal velocity for the
    Linearised Potential Equation in cylindrical coordinates:
    ...
    .. code-block:: python
        ...
        from pfe.models import lpe_axis

        model.add_term(lpe_axi.Velocity(mesh.group(4)), Constant(1.0))
